...
. "$BASH_IT/themes/powerline-multiline-custom/powerline-multiline-custom.base.bash"

PROMPT_CHAR=${POWERLINE_PROMPT_CHAR:="❯"}
POWERLINE_LEFT_SEPARATOR=${POWERLINE_LEFT_SEPARATOR:=""}
POWERLINE_RIGHT_SEPARATOR=${POWERLINE_RIGHT_SEPARATOR:=""}

DISTRO_INFO_NORM_CHAR=$(__powerline_disto_char)
USER_INFO_NORM_CHAR=${USER_INFO_NORM_CHAR:="$DISTRO_INFO_NORM_CHAR"}
USER_INFO_SSH_CHAR=${POWERLINE_USER_INFO_SSH_CHAR:=" "}
#USER_INFO_THEME_PROMPT_COLOR=30
USER_INFO_THEME_PROMPT_COLOR=$(__powerline_disto_color)
#USER_INFO_THEME_PROMPT_COLOR=32
USER_INFO_THEME_PROMPT_COLOR_SUDO=160
...
QTMAIL_THEME_PROMPT_COLOR=160

CWD_THEME_PROMPT_COLOR=240

QTJOB_THEME_PROMPT_COLOR=16

INSCR_THEME_PROMPT_COLOR=18
...
POWERLINE_RIGHT_PROMPT=${POWERLINE_RIGHT_PROMPT:="qtmail in_vim qtjobs battery in_scr clock"}
